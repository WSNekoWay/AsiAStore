...
<head>
  ...
  <title>User's Order History</title>
                        ...
                        <table id="data" class=" table table-striped table-bordered table-sm mb-5 mt-5" cellspacing="0" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="th-sm tdtext">Delete</th>
                                </tr>
                            </thead>
                            <?php
                            $a = 1;
                            $resu=getUser();
                            foreach($resu as $datrow){
                            
                            $result = getHistoryUser($datrow["id"]);
                            ...
                            ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="tdtext"><?=$datrow["id"]?></td>
                                            <td class="tdtext"><?=$datrow["name"]?></td>
