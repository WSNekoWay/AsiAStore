...
if (isset($_POST["deleteBtn"])) {
    ...
    if ($conn != null) {
        $id =$_POST["delete_id"];
        $sql_query = "DELETE FROM `contact` WHERE contact_id = $id";
    ...
    if ($conn != null) {
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $data['name'] = $row["contact_username"];
                $data['type'] = $row["contact_type"];
                $data['userid'] = $row["user_id"];
                $data['text'] = $row["content_text"];
                $data['subtime'] = $row["submit_time"];
                ...
                <table id="data" class=" table table-striped table-bordered table-sm" cellspacing="0" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="th-sm tdtext">Type</th>                     
                      <th class="th-sm tdtext">Text</th>
                      <th class="th-sm tdtext">Submit Time</th>
                  ...
                  ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="tdtext"><?= $datarow["type"] ?></td>                         
                          <td class="tdtext"><?= $datarow["text"] ?></td>
                          <td class="tdtext"><?= $datarow["subtime"] ?></td>
                          <td>
                            <form action="" method="POST" enctype="multipart/form-data">
                              <input type="hidden" name="delete_id" value="<?= $datarow["id"] ?>">
                              <input type="hidden" name="delete_name" value="<?= $datarow["name"] ?>">
                              <input type="submit" name="deleteBtn"value="Delete Content">
                            </form>
                          </td>
                        </tr>
                      </tbody>
